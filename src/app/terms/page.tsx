...
const sections: PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "During the account trial, a customer may voluntarily choose a paid plan. Provider billing and the paid subscription period begin immediately after the provider confirms the purchase. Paid access takes priority while active. If paid access ends before the original account trial date, the remaining account trial may continue until that original date.",
