# Apple Small Business Program Status — 2026-08-15
...
Apple states that the Small Business Program uses a 15% commission, requires identification of Associated Developer Accounts, and is generally limited to developers and associated accounts with no more than USD 1 million in proceeds: [program rules](https://developer.apple.com/app-store/small-business-program/). Apple's subscription guidance describes the standard 70%/85% proceeds schedule and 85% from day one for program members: [subscription proceeds](https://developer.apple.com/help/app-store-connect/manage-subscriptions/offer-auto-renewable-subscriptions/).

Recheck this status after an enrollment decision, an ownership/control change, an app transfer, or before updating revenue forecasts.
